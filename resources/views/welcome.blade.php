  ...
  <div class="col-auto info-item">
    ...
    <span class="info-ico">
      <svg viewBox="0 0 24 24" aria-hidden="true">
        <defs>
          <linearGradient id="grad-date" x1="0" y1="24" x2="24" y2="0">
            <stop offset="0" stop-color="#399BFF"/><stop offset="1" stop-color="#EE71F9"/>
          </linearGradient>
        </defs>
        <rect x="3" y="5" width="18" height="14" rx="2" ry="2"
              fill="none" stroke="url(#grad-date)" stroke-width="2"/>
        <line x1="7"  y1="3.5" x2="7"  y2="7"
              stroke="url(#grad-date)" stroke-width="2" stroke-linecap="round"/>
        <line x1="17" y1="3.5" x2="17" y2="7"
              stroke="url(#grad-date)" stroke-width="2" stroke-linecap="round"/>
      </svg>
    </span>
    <p><strong>DATE</strong><span>28 September 2025</span></p>
  </div>
    ...
    <span class="info-ico">
      <svg viewBox="0 0 24 24" aria-hidden="true">
        <defs>
          <linearGradient id="grad-loc" x1="0" y1="24" x2="24" y2="0">
            <stop offset="0" stop-color="#399BFF"/><stop offset="1" stop-color="#EE71F9"/>
          </linearGradient>
        </defs>
        <path fill="url(#grad-loc)"
              d="M12 2a7 7 0 0 0-7 7c0 4.418 7 13 7 13s7-8.582 7-13a7 7 0 0 0-7-7zm0 9.5a2.5 2.5 0 1 1 0-5 2.5 2.5 0 0 1 0 5z"/>
      </svg>
    </span>
    <p><strong>LOCATION</strong><span>Kampus B, Jl. Gedong</span></p>
  </div>
    ...
    <span class="info-ico">
      <svg viewBox="0 0 24 24" aria-hidden="true">
        <defs>
          <linearGradient id="grad-org" x1="0" y1="24" x2="24" y2="0">
            <stop offset="0" stop-color="#399BFF"/><stop offset="1" stop-color="#EE71F9"/>
          </linearGradient>
        </defs>
        <line x1="19" y1="3" x2="19" y2="21"
              stroke="url(#grad-org)" stroke-width="2" stroke-linecap="round"/>
      </svg>
    </span>
    <p><strong>ORMAWA</strong><span>32 Ormawa</span></p>
  </div>
</div>
